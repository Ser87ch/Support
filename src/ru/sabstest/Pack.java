...
public class Pack {
	...
	public static void createRpack()
	{
		try {
			...
			byte[] f = new byte[25];
			f = "ЁЋ≈ “–ќЌЌќ≈ ѕќƒ“¬≈–∆ƒ≈Ќ»≈".getBytes("cp866"); //ЁЋ≈ “–ќЌЌќ≈ ѕќƒ“¬≈–∆ƒ≈Ќ»≈
	...
	public static String getRPackName()
	{
		try {
			...
			Log.msg("»м€ файла S пакета " + "p$" + s + "r" + new SimpleDateFormat("ddMM").format(Settings.operDate) + "." + Settings.bik.substring(4,6) + "i .");
	...
	public static String getSPackName()
	{
		try {
			...
			Log.msg("»м€ файла S пакета " + "p$" + s + "s" + new SimpleDateFormat("ddMM").format(Settings.operDate) + "." + Settings.bik.substring(4,6) + "i .");
